...
import type { Collidable, Identifiable, Updatable, Healthy } from "services/state";
import type { Vector } from "services/vector";

const RADIUS = 30;

export interface House extends Identifiable, Updatable, Vector, Collidable, Healthy {
  type: "house";
  color: "blue";
